...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customAdapter = new CustomAdapter(MainActivity.this,this, list_id, list_todo, list_date,
                list_duration);
    ...
    void storeDataInArrays(){
        ...
        if(cursor.getCount() == 0){
            ...
            while (cursor.moveToNext()){
                ...
                list_duration.add(cursor.getString(3));
            }
    ...
    void confirmDialog(){
        ...
        builder.setTitle("Delete All To-Do List?");
        builder.setMessage("Confirm Deletion of all To-Do List");
