...
class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_DURATION = "list_duration";
    ...
    void addBook(String title, String date, int duration){
    ...
    void updateData(String row_id, String title, String date, String duration){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COLUMN_TODO, title);
        cv.put(COLUMN_DATE, date);
